...
pub fn rcdata_end_tag_name_state_transition(
  ...
  println!("RCDATA End Tag Name State c: '{:?}'", c);

  return match c {
    Some('\u{0009}') |
    Some('\u{000A}') |
    Some('\u{000C}') |
    Some('\u{0020}') => rcdata_end_tag_name_state_transition_whitespace(c, current_state, current_token, temporary_buffer, recent_start_tag),
    Some('\u{002F}') => rcdata_end_tag_name_state_transition_solidus(c, current_state, current_token, temporary_buffer, recent_start_tag),
    Some('\u{003E}') => rcdata_end_tag_name_state_transition_greater_than_sign(c, current_state, current_token, temporary_buffer, recent_start_tag),
    Some(x) if x.is_ascii_uppercase() => rcdata_end_tag_name_state_transition_ascii_upper_alpha(c, current_token, temporary_buffer),
    Some(x) if x.is_ascii_lowercase() => rcdata_end_tag_name_state_transition_ascii_lower_alpha(c, current_token, temporary_buffer),
    _ => rcdata_end_tag_name_state_transition_anything_else(c, current_state, temporary_buffer),
  }
}

fn rcdata_end_tag_name_state_transition_whitespace(
  c: Option<char>, 
  current_state: &mut DataState,
  current_token: &mut Option<Token>,
  ...
  println!("RCDATA End Tag Name State Whitespace: '{:?}'", c);
  ...
  return rcdata_end_tag_name_state_transition_anything_else(c, current_state, temporary_buffer);
}

fn rcdata_end_tag_name_state_transition_solidus(
  c: Option<char>, 
  current_state: &mut DataState,
  current_token: &mut Option<Token>,
  temporary_buffer: &String,
  ...
  println!("RCDATA End Tag Name State Solidus: '{:?}'", c);
...
fn rcdata_end_tag_name_state_transition_greater_than_sign(
  c: Option<char>, 
  current_state: &mut DataState,
  current_token: &mut Option<Token>,
  temporary_buffer: &String,
  ...
  println!("RCDATA End Tag Name State Exclamation Mark: '{:?}'", c);
...
fn rcdata_end_tag_name_state_transition_ascii_upper_alpha(
  c: Option<char>,
  current_token: &mut Option<Token>,
  temporary_buffer: &mut String
) -> (Option<Vec<Token>>, bool) {
...
fn rcdata_end_tag_name_state_transition_ascii_lower_alpha(
  c: Option<char>,
  current_token: &mut Option<Token>,
  temporary_buffer: &mut String
) -> (Option<Vec<Token>>, bool) {
...
fn rcdata_end_tag_name_state_transition_anything_else(
  c: Option<char>,
  current_state: &mut DataState,
  temporary_buffer: &String
) -> (Option<Vec<Token>>, bool) {
  println!("RCDATA End Tag Name State Anything Else: '{:?}'", c);
