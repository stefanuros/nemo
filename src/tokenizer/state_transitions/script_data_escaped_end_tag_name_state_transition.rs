...
pub fn script_data_escaped_end_tag_name_state_transition(
  ...
  println!("Script Data Escaped End Tag Name State c: '{:?}'", c);

  return match c {
    Some('\u{0009}') |
    Some('\u{000A}') |
    Some('\u{000C}') |
    Some('\u{0020}') => script_data_escaped_end_tag_name_state_transition_whitespace(c, current_state, current_token, temporary_buffer, recent_start_tag),
    Some('\u{002F}') => script_data_escaped_end_tag_name_state_transition_solidus(c, current_state, current_token, temporary_buffer, recent_start_tag),
    Some('\u{003E}') => script_data_escaped_end_tag_name_state_transition_greater_than_sign(c, current_state, current_token, temporary_buffer, recent_start_tag),
    Some(x) if x.is_ascii_uppercase() => script_data_escaped_end_tag_name_state_transition_ascii_upper_alpha(c, current_token, temporary_buffer),
    Some(x) if x.is_ascii_lowercase() => script_data_escaped_end_tag_name_state_transition_ascii_lower_alpha(c, current_token, temporary_buffer),
    _ => script_data_escaped_end_tag_name_state_transition_anything_else(c, current_state, temporary_buffer),
  }
}

fn script_data_escaped_end_tag_name_state_transition_whitespace(
  c: Option<char>, 
  current_state: &mut DataState,
  current_token: &mut Option<Token>,
  ...
  println!("Script Data Escaped End Tag Name State Whitespace: '{:?}'", c);
  ...
  return script_data_escaped_end_tag_name_state_transition_anything_else(c, current_state, temporary_buffer);
}

fn script_data_escaped_end_tag_name_state_transition_solidus(
  c: Option<char>, 
  current_state: &mut DataState,
  current_token: &mut Option<Token>,
  temporary_buffer: &String,
  ...
  println!("Script Data Escaped End Tag Name State Solidus: '{:?}'", c);
...
fn script_data_escaped_end_tag_name_state_transition_greater_than_sign(
  c: Option<char>, 
  current_state: &mut DataState,
  current_token: &mut Option<Token>,
  temporary_buffer: &String,
  ...
  println!("Script Data Escaped End Tag Name State Exclamation Mark: '{:?}'", c);
...
fn script_data_escaped_end_tag_name_state_transition_ascii_upper_alpha(
  c: Option<char>,
  current_token: &mut Option<Token>,
  temporary_buffer: &mut String
) -> (Option<Vec<Token>>, bool) {
...
fn script_data_escaped_end_tag_name_state_transition_ascii_lower_alpha(
  c: Option<char>,
  current_token: &mut Option<Token>,
  temporary_buffer: &mut String
) -> (Option<Vec<Token>>, bool) {
...
fn script_data_escaped_end_tag_name_state_transition_anything_else(
  c: Option<char>,
  current_state: &mut DataState,
  temporary_buffer: &String
) -> (Option<Vec<Token>>, bool) {
  println!("Script Data Escaped End Tag Name State Anything Else: '{:?}'", c);
